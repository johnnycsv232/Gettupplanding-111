        ...
        >
          ...
          <div className="relative flex flex-col items-center gap-12">
            ...
            <motion.div
              ...
              className="relative flex size-24 items-center justify-center rounded-2xl bg-vegas-gold shadow-[0_0_50px_rgba(212,175,55,0.4)]"
            >
              <motion.span
              ...
              <motion.div
                ...
                className="border-vegas-gold/30 absolute inset-[-10px] rounded-2xl border"
              />
            </motion.div>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <motion.span
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-vegas-gold/50 font-mono text-[10px] uppercase tracking-[0.2em]"
              >
          ...
          <div className="pointer-events-none absolute inset-0 flex select-none items-center justify-center overflow-hidden">
            <span className="text-[30vw] font-black tracking-tighter text-white/[0.02]">
              GETTUPP
            </span>
          </div>
        </motion.div>
